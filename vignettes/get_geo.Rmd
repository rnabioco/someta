...
https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=gds&query_key=1&WebEnv=MCID_5f88cc1a5ba549283b24e861
...
g <- ggplot(gds_sum %>% filter(n >= 3) %>% 
         mutate(journal_group = factor(journal_group, 
                                       ...
                                       levels = c("CNS", "CNS sub", "eLife", "PLOS", "BMC", "other")
                                       )),
